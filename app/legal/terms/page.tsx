          ...
          <Card>
            ...
            <CardContent className="prose prose-zinc dark:prose-invert max-w-none space-y-6">
              <section>
                ...
                <p>
                  By accessing or using PickMyClass (the &quot;Service&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;).
              ...
              <section>
                ...
                <p>
                  You must meet the following requirements to use this Service:
                </p>
                ...
                <p className="font-semibold text-amber-600 dark:text-amber-400">
                  This Service is available only to users located in the United States.
                  By using this Service, you represent that you are a US resident.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  PickMyClass provides a class availability monitoring service for Arizona State University (ASU) students.
                ...
                <p>
                  The Service operates by periodically checking ASU&apos;s class search system and notifying users of changes.
                  We do not guarantee real-time updates or the accuracy of information provided by ASU&apos;s systems.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>The Service does NOT register you for classes - it only notifies you of availability</li>
                  <li>Notifications may be delayed and seats may fill before you receive notification</li>
                  <li>We check class availability periodically (approximately every hour) and cannot guarantee immediate notifications</li>
              ...
              <section>
                ...
                <p className="font-semibold">
                  PickMyClass is an independent service and is NOT affiliated with, endorsed by, or sponsored by Arizona State University.
                  ASU trademarks and data are used for informational purposes only.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  The Service, including its code, design, and content (excluding ASU data), is owned by the PickMyClass Team.
              ...
              <section>
                ...
                <p className="font-semibold uppercase">
                  To the maximum extent permitted by law, PickMyClass Team shall not be liable for any indirect, incidental, special, consequential,
                ...
                <p className="font-semibold">
                  Our total liability to you for all claims shall not exceed $100 USD or the amount you paid for the Service in the past 12 months, whichever is greater.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  You agree to indemnify and hold harmless PickMyClass Team from any claims, damages, or expenses arising from:
                </p>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                ...
                <p>
                  These Terms shall be governed by and construed in accordance with the laws of the United States and the State of Arizona,
                  without regard to conflict of law principles. Any disputes shall be resolved in the courts of Arizona.
                </p>
              </section>
              ...
              <section className="border-t pt-6">
                <p className="text-sm text-muted-foreground">
                  By creating an account and using PickMyClass, you acknowledge that you have read, understood,
