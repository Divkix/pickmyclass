        ...
        if (scraperUrl && scraperToken) {
          try {
            ...
            if (!scraperResponse.ok) {
              ...
              Sentry.captureMessage('Scraper service error when adding class watch', {
                level: 'error',
                tags: {
                  component: 'api',
                  endpoint: '/api/class-watches',
                ...
                extra: {
                  class_nbr,
                  term,
                  statusCode: scraperResponse.status,
                  errorText,
                },
                user: { id: user.id },
              })
            ...
            if (!scraperData.success || !scraperData.data) {
              ...
              Sentry.captureMessage('Scraper returned unsuccessful response', {
                level: 'error',
                tags: {
                  component: 'api',
                  endpoint: '/api/class-watches',
