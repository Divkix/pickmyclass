/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=/dev/null --env-interface=CloudflareEnv lib/cloudflare-env.d.ts` (hash: 1def0056f3df343475d9041d63e3aa8f)
