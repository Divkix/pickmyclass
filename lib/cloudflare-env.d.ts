/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv lib/cloudflare-env.d.ts` (hash: f5aef48a2188242b29fa13a6223033d2)
// Runtime types generated with workerd@1.20260708.1 2026-05-07 global_fetch_strictly_public,nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_WATCHES_PER_USER" | "NOTIFICATION_FROM_EMAIL" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_POSTHOG_PROJECT_TOKEN" | "NEXT_PUBLIC_POSTHOG_HOST">> {}
}
