/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv lib/cloudflare-env.d.ts` (hash: c2064343ad66b1be223b8cd1db614c3e)
// Runtime types generated with workerd@1.20251210.0 2025-10-21 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../worker");
		durableNamespaces: "CircuitBreakerDO" | "CronLockDO";
	}
	interface Env {
		...
		CIRCUIT_BREAKER_DO: DurableObjectNamespace /* CircuitBreakerDO from pickmyclass */;
		CRON_LOCK_DO: DurableObjectNamespace /* CronLockDO from pickmyclass */;
		CLASS_CHECK_QUEUE: Queue;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_WATCHES_PER_USER" | "NEXT_PUBLIC_SITE_URL" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "SCRAPER_URL" | "SCRAPER_SECRET_TOKEN" | "SCRAPER_BATCH_SIZE" | "RESEND_API_KEY" | "NOTIFICATION_FROM_EMAIL" | "WRANGLER_BUILD_CONDITIONS" | "WRANGLER_BUILD_PLATFORM">> {}
}
