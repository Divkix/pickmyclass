/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=/dev/null --env-interface=CloudflareEnv lib/cloudflare-env.d.ts` (hash: eeac0d51bb9e161123b43e2a22ac8fa3)
// Runtime types generated with workerd@1.20260811.1 2026-05-07 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	SECTION_CHECK_WORKFLOW: Workflow<Parameters<import("../worker").SectionCheckWorkflow['run']>[0]['payload']>;
	MAINTENANCE_WORKFLOW: Workflow<Parameters<import("../worker").MaintenanceWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MAX_WATCHES_PER_USER" | "NOTIFICATION_FROM_EMAIL" | "NEXT_PUBLIC_SITE_URL">> {}
}
