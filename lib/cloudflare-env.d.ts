/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv lib/cloudflare-env.d.ts` (hash: 395fd943228acdb0605f13f1e55e8eb6)
// Runtime types generated with workerd@1.20260301.1 2025-10-21 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../worker");
		durableNamespaces: "CronLockDO";
	}
	interface Env {
		...
		PICKMYCLASS_CRON_LOCK_DO: DurableObjectNamespace<import("../worker").CronLockDO>;
	}
}
