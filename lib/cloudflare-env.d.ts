/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --env-file=/dev/null --env-interface=CloudflareEnv lib/cloudflare-env.d.ts` (hash: ce7d838a920f427586484f5a0aaa47ad)
